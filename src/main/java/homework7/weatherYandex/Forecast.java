...
public class Forecast {
    ...
    public Hour[] getHours() { return hours; }
    public void setHours(Hour[] hours) { this.hours = hours; }

    public Biomet getBiomet() { return biomet; }
    public void setBiomet(Biomet biomet) { this.biomet = biomet; }
}
